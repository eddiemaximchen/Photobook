...
from photobook.models import db,User,Photo,Tag,Comment,Notification
...
def fake_admin():
    ...
    notification = Notification(message='Hello, welcome to Photobook.', receiver=admin)
...
def fake_photo(count=30):
    # photos
    upload_path = current_app.config['PHOTOBOOK_UPLOAD_PATH']
    for i in range(count):
        print(i)
